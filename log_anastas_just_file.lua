...
local function say(level, fmt, ...)
    ...
    --print("найденное имя поиском по модулям: ", get_module_name_by_func(3))
    local module_name = module_name_by_func(3)
    -- print("найденное имя из файла: ", module_name_by_func(3))
